...
create table course_students (courses_id integer not null, students_id integer not null, primary key (courses_id, students_id));
create table course_teachers (courses_id integer not null, teachers_id integer not null, primary key (courses_id, teachers_id));
